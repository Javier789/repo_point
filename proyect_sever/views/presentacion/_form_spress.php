...
<?php } else { ?>
                            ...
                            <div class="col-md-3" style=""><img class="img-fluid d-block justify-content-center align-items-center w-100" src="http://saveabandonedbabies.org/wp-content/uploads/2015/08/default.png" width="150px"></div>
                            <div class="col-md-9" style="">
                                <h4>sin dato</h4>
                                <h6>sin datos</h6>
                                <p> sin datos</p>
                                <h5 class="py-1">Costo:$0,00</h5>
                                <h5 class="py-1">Precio Sugerido:$0,00</h5>
                            </div>
...
<?= $form->field($stockData, 'numeroComprobante')->hiddenInput(['value' => $stockData->numeroComprobante])->label(false); ?>
        <!--                    <input type="number" class="form-control-lg" id="numCantidad" placeholder="0,00" style="" value="1" autofocus onfocus="this.select();" onkeyup="enterCantidad(event);">-->
                    ...
                    <div class="col-md-3">
                        <h2 class="">Costo c/u</h1>
                    </div>
                    <div class="col-md-9">
                        <div class="input-group mb-2 mr-sm-2 input-group-lg">
                                <?= $form->field($stockData, 'costo')->textInput(['class' => 'form-control-lg', 'placeholder' => '0,00', 'style' => 'font-size:24px; disabled:"' . $cantidadActivar . '"', 'disabled' => !$hayPresentacion, 'value' => $hayPresentacion?$model->costo:0, 'autofocus' => $focoCantidad, 'onfocus' => 'this.select()', 'onkeeyup' => 'enterCantidad(event);'])->label(false); ?>
                        </div>
                    </div>
                </div>
                        ...
                        'columns' => [
                            ...
                            'presentacion.costo',
                                ...
                                'value' => function($model) {
                                    return "" . ($model->cantidad * $model->presentacion->costo);
                                }
                            ]
                        ],
                    ]);
