...
<div class="wrap">
  ...
  <nav class="navbar navbar-expand-md navbar-dark bg-primary" style="margin-bottom:0px">
    <div class="container" style="  align-items: left !important; display: initial; margin-left: 10px;"> <a class="navbar-brand" href="#">
...
<!--                <li>
                  ...
                  <?php echo Yii::$app->user->isGuest ? (
                    ...
                    . Html::submitButton(
                        ...
                        ['class' => 'btn btn-link logout', 'style'=>'font-size:1.5em']
                    )
                    . Html::endForm().
                      ' </span>'
                     . '</a>'    
